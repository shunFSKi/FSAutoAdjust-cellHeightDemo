...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.2"
  s.summary      = "A FSAutoAdjust-cellHeight."
  ...
  s.description  = <<-DESC
                   cell行高自适应，一句代码搞定需求，丝滑般顺畅的滚动体验，原理简单，使用方便
                   DESC
  ...
  s.author             = { "冯顺" => "fengshun_ios@126.com" }
  # Or just: s.author    = "冯顺"
  # s.authors            = { "冯顺" => "" }
  ...
  s.source_files  = "FSAutoAdjust-cellHeightLib", "FSAutoAdjust-cellHeightLib/**/*.{h,m}"
